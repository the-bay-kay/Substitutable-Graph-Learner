...
'''
    ...
    TO RUN: In order to run the full version of this script,
        ...
        be installed via pip as required.
            - networkx
            - matplotlib
        Additionally, when processing larger texts, the scipi module may
            be required for networkx to function properly.
    Comment Notation:
...
default=False, help='Vizualize the Substitution Graph, '
        'saved as a .png within the same directory '
